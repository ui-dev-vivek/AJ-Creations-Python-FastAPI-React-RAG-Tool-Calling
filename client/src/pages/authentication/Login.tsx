...
const Login: React.FC = () => {
  ...
  const [firstTime, setFirstTime] = React.useState<boolean>(false);
              ...
              {!otpSent ? (
                <>
                  ...
                  <div className="flex flex-col gap-4 mt-6 bg-white">
                    +91
                    <Input
                      className="w-full bg-white shadow-none border-b border-default-200 focus:outline-none focus:border-primary"
                      label="Phone Number"
                ...
                <>
                  ...
                  <button
                    ...
                    className="mt-3 text-small w-full text-primary"
                  >
